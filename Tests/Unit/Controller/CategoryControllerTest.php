...
/**
 * Test case for class Stilbezirk\infinitefilter\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Stilbezirk\infinitefilter\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Stilbezirk\\infinitefilter\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function createActionAddsTheGivenCategoryToCategoryRepository() {
		...
		$categoryRepository = $this->getMock('', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenCategoryInCategoryRepository() {
		...
		$categoryRepository = $this->getMock('', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenCategoryFromCategoryRepository() {
		...
		$categoryRepository = $this->getMock('', array('remove'), array(), '', FALSE);
